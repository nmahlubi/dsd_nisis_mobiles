...
class NextDetailsScreen extends StatefulWidget {
  final Map<String, dynamic> data;
  const NextDetailsScreen({super.key, required this.data});

  @override
  State<NextDetailsScreen> createState() => _NextDetailsScreenState();
}

class _NextDetailsScreenState extends State<NextDetailsScreen> {
